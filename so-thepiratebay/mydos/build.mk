...
# By default, the bootable program name will be tpdos.bin
...
$(dos).bin : bootloader.o bios1.o kernel.o kaux.o bios2.o logo.o syscall.o
	ld -melf_i386 -T tpdos.ld --orphan-handling=discard $^ -o $@
...
$(dos).bin : .EXTRA_PREREQS = rt0.o tpdos.ld
...
libtpdos.o: libtpdos.c tpdos.h
	gcc -m16 -O0 --freestanding -fno-pic $(NO_CF_PROTECT) -c  $< -o $@

libtpdos.o : tpdos.h

libtpdos.a : libtpdos.o
	ar rcs $@ $^
